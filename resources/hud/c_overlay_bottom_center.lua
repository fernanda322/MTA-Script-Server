		...
		if ( getPedWeapon( localPlayer ) ~= 43 or not getControlState( "aim_weapon" ) ) then
			...
			for i=1, #content do
				if content[i] then
					...
					dxDrawText( content[i][1] or "" , posX+16, posY+(16*i), w-5, 15, tocolor ( content[i][2] or 255, content[i][3] or 255, content[i][4] or 255, content[i][5] or 255 ), content[i][6] or 1, ( (i == 1) and BizNoteFont18 ) or (content[i][7]) or ("default") )
				end
